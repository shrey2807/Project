...
public:
    ...
    void printclgstudents(int n)
    {
        int a;
        ofstream clgstu;
        clgstu.open("Clgdata.dat");

        clgstu << "College: " << colleges[n] << endl;
        clgstu << "Computer Science: " << b[0] << endl;
...
{
    string name;
    int total, physics, maths, chemistry, rank, srno, clg1 = -1;
    vector<int> choices;

public:
    float phyper, cheper, matper, totper;
    individual()
    {
        int a, b;
        for (int i = 0; i < 3; i++)
    ...
    void sorteddata()
    {
        ...
        if (clg1 == -1)
        {
            ...
            write1 << "Go back to Modi school lol" << endl;
            write1 << endl;
        }
        else
        {
...
int main()
{
    ...
    colleges.push_back("IIT Madras");
    colleges.push_back("NIT");
    colleges.push_back("BITS");
    colleges.push_back("IIITV");
    colleges.push_back("VVP");
    colleges.push_back("IIT-JAM");
    colleges.push_back("Atmiya");
    colleges.push_back("Marwadi");
    ...
    // cout << clg[0].b[0] << endl;
    // for (int i = 0; i < clg[0].branch1.size(); i++)
    // {
    //     cout << clg[0].branch1[i] << " ";
    // }
