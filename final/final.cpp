...
void withdraw()
{
    ...
    {
        // srand(time(0));
        // aaya e manas nu clg -2 karvanu che etle vector of srno and rank banavu padse
        // int a = rand() % (clg[i].branch1.size() - 3);

        int a = 0;

        person[clg[i].branch1[a] - 1].clg1 = -2;
        clg[i].branch1.erase(clg[i].branch1.begin() + a);
        cout << "between 1" << endl;
        person[clg[i].branch1[a] - 1].clg1 = -2;
        clg[i].branch1.erase(clg[i].branch1.begin() + a);
        ...
        // int b = rand() % (clg[i].branch2.size() - 3);
        int b = 0;
        ...
        // int c = rand() % (clg[i].branch3.size() - 3);
        int c = 0;

        person[clg[i].branch3[c] - 1].clg1 = -2;
        clg[i].branch3.erase(clg[i].branch3.begin() + c);
        cout << "between 3" << endl;
        person[clg[i].branch3[c] - 1].clg1 = -2;
        clg[i].branch3.erase(clg[i].branch3.begin() + c);
...
int main()
{
    ...
    cout << "How many new users do you want to create?" << endl;
    cin >> no_of_user;
    ...
    person = new individual[cnt + no_of_user];
